...
public class ConsoleTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            {
                drawRect(this.xPos - 1, this.yPos - 1, this.xPos + this.width + 1, this.yPos + this.height + 1, 0x440077);
                drawRect(this.xPos, this.yPos, this.xPos + this.width, this.yPos + this.height, 0xFFFFFF);
            }
            ...
            int var7 = this.enableBackgroundDrawing ? this.xPos + 24 : this.xPos;
            ...
            if (var6)
            {
                if (var13)
                {
                    Gui.drawRect(var11, var8 - 1, var11 + 1, var8 + 1 + this.fontRenderer.FONT_HEIGHT, 0xFFFFFF);
                }
                else
                {
                    this.fontRenderer.drawStringWithShadow("_", var11, var8, 0xFFFFFF);
                }
            }
